...
check("password1").notEmpty().withMessage("El campo cnfirmación de contraseña no puede estar vacío").bail().isLength({min:6}).withMessage("La contraseña debe contener 6 caracteres mínimo"),
